...
- `Все примеры НАМ` — [кликни здесь](/lectures/1sem/day5/markov_examples.md)
...
- Выжимка из книги "Теория алгорифмов" Маркова — [ознакомиться](/lectures/1sem/day5/markov_algorifm.md)
