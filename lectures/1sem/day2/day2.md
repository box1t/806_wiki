...
<details>
<summary>Кликни на объяснение:</summary>
<br>
...
<details>
<summary>А почему именно логарифм? Кликни:</summary>
<br>
...
<details>
<summary>Про двоичные триады и тетрады:</summary>
<br>
...
- Если хорошо понимаете дополнительный и обратный код, можно блеснуть знанием на зачёте. Но это уже опционально, и объяснить с ходу непросто.
...
<details>
<summary>Про PC WEEK и ошибку Y2038:</summary>
<br>
...
```
- Частично повествование будет записано фактами, набором мыслей.
- Здесь описаны преимущества OC Unix.
