...
> ***Составной знак*** (***слово***) — конечная последовательность знаков (любых. Неважно, атомарных или составных).
...
- ***Клавиатурная раскладка*** — это не только размещение букв по клавишам, но и сопоставление этим буквам [аппаратных сканкодов](https://github.com/box1t/Moscow_Aviation_Wikipedia/blob/main/lectures/1sem/day1/Аппаратный%20сканкод.md), т. е. преобразование алфавитов.
